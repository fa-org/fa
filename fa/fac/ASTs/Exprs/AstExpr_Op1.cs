			...
			if (Value is AstExpr_BaseId _idexpr1) {
				...
				Func<IAstExpr, IAstType, IAstExpr> _access_func2 = (_obj, _typeexpr) => {
					return _typeexpr switch {
						...
						AstType_ArrayWrap when _access_name == "Length" => AstExpr_ArrayAPI_Temp.Array_Length (_obj),
						AstType_String    when _access_name == "Length" => AstExpr_ArrayAPI_Temp.Array_Length (_obj),

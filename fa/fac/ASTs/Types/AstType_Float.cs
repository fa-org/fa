...
namespace fac.ASTs.Types {
	class AstType_Float: IAstType {
		...
		public override (string, string) GenerateCSharp (int _indent, Action<string, string> _check_cb) => ("", BitWidth == 32 ? "float" : (BitWidth == 64 ? "double" : throw new UnimplException (Token)));

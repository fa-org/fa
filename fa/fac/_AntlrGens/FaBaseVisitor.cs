...
public partial class FaBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IFaVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTypeWrapVar([NotNull] FaParser.TypeWrapVarContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTypeWrapVarList([NotNull] FaParser.TypeWrapVarListContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTypeWrapVar2List([NotNull] FaParser.TypeWrapVar2ListContext context) { return VisitChildren(context); }
	/// <summary>
